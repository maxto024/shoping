...
<div id="wrapper">
	<div id="note">
		...
		For inquiries and order cancelation please contacts: (880)1626214466 or email us  maxto024@gmail.com 
	</div>
	<div id="content">
		<div id="productlist">
		...
		<div id="orderlist">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				...
				<option value="2">Shipping Inside Djibouti</option>
				<option value="3">Shipping Outside Djibouti</option>
				</select></td>
			  </tr>
			  <tr style="">
    ...
    Customer Services((880)1626214466)
    <span>
...
<a href="#" class="tooltip">
    ...
    <span>
        <img class="callout" src="callout.gif" />
        <strong>Free Shipping Inside Djibouti</strong><br />
        <strong>Shipping + 500 Outside Djibouti</strong>
    </span>
</a>
	</div>
	<div class="clearfix"></div>
