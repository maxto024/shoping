...
<img src="../images/logo.png" width="100" height="100" style="float:left;"><strong>Djibouti Online Ordering System</strong><br>Balete Batangas City<br>Email Us: GENESIS_PS@YAHOO.COM.PH<br>Contact: <a href="#">(1800)777-111</a> and call on <a href="#">(+6343)3005704</a>
<br><br><br><br>
<?php
include('connect.php');
		$id=$_GET['id'];
